...
export default function App({ navigation }) {
  ...
  useEffect(() => {
    ...
    api.searchloai("đồng hồ").then(data1=> {
  ...
  const renderItem = ({item})=>{
    ...
    return(
        <View style={{height:'auto'}}>
                 <TouchableOpacity style={{backgroundColor:'white',borderRadius:20,marginLeft:5,marginTop:10,height:280}}>
                    <Image
                        style={styles.sp}
        ...
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <View style={styles.text}>
                    <Text style={styles.date}>Đồng Hồ</Text>
                </View>
                <TouchableOpacity>
                    <View style={styles.item}>
