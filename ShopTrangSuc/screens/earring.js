...
export default function App({ navigation }) {
  ...
  useEffect(() => {
    ...
    api.searchloai("bông tai").then(data1=> {
        ...
        <TouchableOpacity onPress={() => navigation.navigate('chitietsanpham', {
          ...
          <View>
            ...
            <NumberFormat
                        ...
                        displayType={'text'}
                        thousandSeparator={true}
                        renderText={value => <Text style={styles.price}>{<Text style={styles.chuduoi}>{value} ₫</Text>}</Text>}/> 
          </View>
        ...
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <View style={styles.text}>
                    <Text style={styles.date}>Bông Tai</Text>
                </View>
                <TouchableOpacity>
                    <View style={styles.item}>
